...
(select) box with a button or link to activate the selection.
...
or (as of version 2.0) be rendered as auto-navigating select boxes.  Also, as of
version 2.0, you can specify the text that will appear in the link or on the
button.

NOTE FOR 1.0 USERS - As of version 2.0, the CSS parameters have been removed, as
